...
export default function ServicesSection() {
  return (
    <section id="services" className="w-full bg-transparent py-24 px-6 border-t border-white/10">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-[#86868b] text-lg max-w-xl mx-auto leading-relaxed">
            From Hollywood-grade CGI to real-time WebGL ΓÇö we engineer visuals that captivate audiences.
          </p>
        </div>
