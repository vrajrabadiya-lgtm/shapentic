...
const faqs = [
  ...
  { q: "How does your AI-powered pipeline differ from traditional CGI studios?", a: "Our proprietary neural engine extracts 3D depth maps and generates frame continuations using diffusion models, reducing iteration cycles from weeks to hours — typically 5× faster than conventional CGI production at Hollywood-grade quality." },
  { q: "What is the typical project turnaround time?", a: "Most standard 3D animation projects deliver the first draft within 48–72 hours. Complex cinematic sequences with physics, character rigging, or architectural flythroughs may take 5–7 business days for full production." },
  { q: "Do you provide full commercial licensing on all delivered assets?", a: "Yes — all projects include 100% commercial IP transfer. You receive full royalty-free ownership of all 3D renders, video files, source files (where applicable), and any custom assets created for your project." },
  { q: "Can Shapentic integrate interactive 3D directly into my website?", a: "Absolutely. We build WebGL / Three.js interactive 3D scenes and React components that embed directly into web platforms — including 360° product rotators, animated landing sections, and real-time 3D configurators." },
